...
export function ItemDetailPage() {
  ...
  const cambiarCantidad = (
    ii: { id: string; cantidadMin: number; cantidadMax: number },
    delta: number,
  ) => {
    setAgregados((prev) => {
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="p-5 space-y-5">
          ...
          <div>
            ...
            {item.descripcion && (
              <p className="text-sm text-gray-500 mt-1 leading-relaxed">{item.descripcion}</p>
            )}
                  ...
                  >
                    ...
                    {ii.esRemovible ? (
                      <button
                        ...
                        className="text-xs font-semibold text-orange-500 bg-orange-50 px-3 py-1 rounded-full"
                      >
                      ...
                      <div>
                        ...
                        {Number(ii.precioExtra) > 0 && (
                          <p className="text-xs text-orange-500 font-semibold">
                            +${Number(ii.precioExtra).toFixed(2)} c/u
                          </p>
                        )}
                      </div>
